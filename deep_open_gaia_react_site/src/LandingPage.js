  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <section className="text-center py-20 px-4">
        ...
        <button className="bg-white text-black font-bold px-6 py-3 rounded-full shadow hover:bg-gray-200">
          Partner With Us
        </button>
      </section>
      ...
      <section className="text-center py-12 border-t border-gray-700">
        ...
        <form className="flex flex-col items-center gap-4 max-w-md mx-auto">
          <input type="email" placeholder="Your email address" className="px-4 py-2 rounded-lg w-full text-black" />
          <button type="submit" className="bg-white text-black px-6 py-2 rounded-full font-semibold hover:bg-gray-300">
      ...
      <footer className="text-center py-6 text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} DEEP OPEN GAIA • All rights reserved • deepopengaia.com
      </footer>
    </div>
  );
}
